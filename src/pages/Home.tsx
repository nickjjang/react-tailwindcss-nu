        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-24 md:mt-36">
          <div className="order-2 md:order-1 flex mt-20 -ml-32 md:mt-0 md:ml-0">
            <div className="flex-1 rounded-tl-full rounded-tr-full border-grey-400 border-2 border-b-0 border-dashed max-w-sm px-8 pt-8">
              <div className="rounded-tl-full rounded-tr-full gradient-bg-1 relative h-160">
                <img src={Assets.images.homeWhatisNu} alt="What is Nu" className="animate-pulse drop-shadow-lg absolute top-32 left-1/3 w-screen-80 max-w-max md:w-144"/>
              </div>
            </div>
          </div>
          <div className="order-1 md:order-2 max-w-md">
            ...
            <p className="mt-5">
              Due to changing requirements of our global economy and society, schools are forced to become.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-4 lg:container lg:mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 mt-24 md:mt-36">
          <div className="order-2 md:col-span-8 lg:col-span-6 md:order-1 flex flex-col md:block mt-16 md:mt-0">
            <div className="flex flex-col md:relative w-full md:h-104">
              <div className="order-1 relative md:absolute md:top-10 md:left-1/3 md:transform md:-translate-x-1/2 h-80 md:h-auto">
                <div className="absolute right-1/4 h-auto md:static w-48">
                  ...
                  <Card
                    ...
                    content="Typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,"
              ...
              <div className="order-2 relative md:absolute md:top-0 md:right-1/3 md:transform md:translate-x-1/2 h-40 md:h-auto">
                <div className="absolute left-1/4 h-auto md:static w-40">
                  ...
                  <Card
                    mark="4,9/5"
                    rating={Assets.images.rating5}
                    content2="Lorem Ipsum has been the industry's standard" />
                </div>
              </div>
              ...
              <div className="order-4 relative md:absolute md:bottom-0 md:left-1/3 md:transform md:-translate-x-1/3 h-36 md:h-auto">
                <div className="absolute left-1/4 h-auto md:static w-52">
                  <Card
                    content2="“Typesetting industry. Lorem Ipsum has been the industry's standard du”" />
              ...
              <div className="order-3 relative md:absolute md:bottom-1/3 md:right-1/3 md:transform md:translate-x-2/3 md:translate-y-2/3 h-72 md:h-auto">
                <div className="absolute right-1/4 h-auto md:static w-48">
                  ...
                  <Card
                    ...
                    content="Typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the lorem ipsum."
                    rating={Assets.images.rating5}
                    name="Sandra Robbins"
                    content2="Manager" />
