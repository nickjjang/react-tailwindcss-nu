      ...
      <div className="relative px-4 lg:container lg:mx-auto h-10 md:h-16">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center">
            <button className="border border-grey-100 active:bg-indigo-800 rounded-xl px-4 py-2 w-24 text-base lg:text-lg lg:w-32 mr-4 hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-900">
              Sign Up
            </button>
            <button className="border border-grey-100 active:bg-indigo-800 rounded-xl px-4 py-2 w-24 text-base lg:text-lg lg:w-32 hover:bg-black hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-900"
      ...
      >
        ...
        {!user.logined ? 
          <div className="flex items-center">
            <button className="flex-1 border border-grey-100 active:bg-indigo-800 rounded-xl px-4 py-2 text-base mr-2 hover:bg-black hover:text-white focus:outline-none focus:outline-none focus:ring-2 focus:ring-indigo-900">
              Sign Up
            </button>
            <button className="flex-1 border border-grey-100 active:bg-indigo-800 rounded-xl px-4 py-2 text-base ml-4 hover:bg-black hover:text-white focus:outline-none focus:outline-none focus:ring-2 focus:ring-indigo-900"
              onClick={()=>dispatch(login({name:'Sandra K.', job:'student'}))}>
              Sign In
            </button>
          </div>
